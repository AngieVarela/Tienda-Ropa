...
namespace TiendaRosse_MVC.Views
{
    public class ArticulosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre_articulo,Precio,Stock,activo")] Articulos articulos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre_articulo,Precio,Stock,activo")] Articulos articulos)
        {
            if (ModelState.IsValid)
            {
